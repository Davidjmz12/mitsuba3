...
template <typename Float, typename Spectrum> class TemporalProfile;
...
template <typename Float_, typename Spectrum_> struct RenderAliases {
    ...
    using TemporalProfile        = mitsuba::TemporalProfile<FloatU, SpectrumU>;
    ...
    using TemporalProfilePtr     = dr::replace_scalar_t<Float, const TemporalProfile *>;
...
#define MI_IMPORT_OBJECT_TYPES()                                                                   \
    ...
    using TemporalProfile        = typename RenderAliases::TemporalProfile;                        \
    ...
    using TemporalProfilePtr     = typename RenderAliases::TemporalProfilePtr;                     \
